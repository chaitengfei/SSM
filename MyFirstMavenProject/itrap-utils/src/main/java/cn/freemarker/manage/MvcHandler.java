...
import cn.freemarker.utils.Constant;
import cn.freemarker.utils.FreeMarkerUtils;
...
public class MvcHandler {
    ...
    public void executeClazzMapper(Table table) {
        ...
        String savePath = Constant.class_mapper_save_path + "//" + StringUtils.lowerName(table.getClassName()) + "//";
